...
public sealed class OutboxModule : Module
{
    ...
    {
        builder.RegisterAssemblyTypes(NotificationsApplicationAssembly.Assembly)
            .AsClosedTypesOf(typeof(IDomainEventNotification<>))
            .InstancePerDependency()
            .FindConstructorsWith(new AllConstructorFinder());

        builder.RegisterType<OutboxAccessor>()
            .Keyed<IOutbox>("notifications")
            .FindConstructorsWith(new AllConstructorFinder())
        ...
        builder.RegisterType<DomainNotificationsMapper>()
            .Keyed<IDomainNotificationsMapper>("notifications")
            .FindConstructorsWith(new AllConstructorFinder())
    ...
    {
        var domainEventNotifications = NotificationsApplicationAssembly.Assembly
            .GetTypes()
    ...
    private void PopulateDomainNotificationsMap()
    {
        ...
        {
            if (notification.FullName is null) continue;
